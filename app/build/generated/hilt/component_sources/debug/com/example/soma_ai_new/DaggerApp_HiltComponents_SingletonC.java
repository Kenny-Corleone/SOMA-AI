...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, javax.inject.Provider<ViewModel>>singletonMap("com.example.soma_ai_new.MainViewModel", ((Provider) mainViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.soma_ai_new.MainViewModel 
  ...
  private static final class ServiceCImpl extends App_HiltComponents.ServiceC {
    ...
    @Override
    public void injectHotwordService(HotwordService hotwordService) {
    }
  }
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    @Override
    public void injectHotwordReceiver(HotwordReceiver hotwordReceiver) {
    }
