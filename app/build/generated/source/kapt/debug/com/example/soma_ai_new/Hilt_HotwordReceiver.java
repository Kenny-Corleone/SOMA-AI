...
public abstract class Hilt_HotwordReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((HotwordReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectHotwordReceiver(UnsafeCasts.<HotwordReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
